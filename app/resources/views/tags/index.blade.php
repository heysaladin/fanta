                        ...
                        @foreach ($tags as $key => $item)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="POST" action="{{url('tags/destroy/'.$item->id)}}" class="d-inline" onsubmit="return confirm('Delete this data permanently?')">
                                    @csrf
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="{{ url('tags/update/'.$item->id) }}" method="POST">
                                                <input type="hidden" name="_method" value="POST">
                                                @csrf
